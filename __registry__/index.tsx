...
export const Index: Record<string, unknown> = {
  "components": {
    ...
    "login-01": {
      ...
      files: ["registry/components/block/login-01/page.tsx","registry/components/block/login-01/components/form.tsx","registry/components/block/login-01/components/providerDetails.tsx"],
